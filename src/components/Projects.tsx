  ...
  const projects = [
    {
      title: "Ruanghuni",
      description:
        "An exclusive lodging landing page featuring a premium aesthetic, integrated WhatsApp reservation system, and a gallery of high-end rooms designed for ultimate tranquility.",
      image: p8,
      tags: ["React", "CSS", "Vite"],
      demoLink: "#",
      repoLink: "#",
    },
    {
      title: "Nginapyuk",
      description:
        "A comprehensive multi-property booking platform with property listings, advanced search filters, and detail pages, designed for a seamless travel planning experience.",
      image: p7,
      tags: ["React", "CSS", "Vite"],
      demoLink: "#",
      repoLink: "#",
    },
    {
      ...
      description:
        "A comprehensive Point of Sale (POS) platform designed to help businesses manage sales, inventory, and financial reports efficiently.",
      image: p1,
    ...
    },
    {
      ...
      description:
        "A professional company profile website for Inokode, showcasing services, portfolio, and contact information with a sleek modern design.",
      image: p2,
      tags: ["HTML", "CSS", "JS"],
      demoLink: "#",
    ...
    },
    {
      ...
      description:
        "A high-conversion landing page for FitLife, a health and fitness companion app designed to track workouts and nutrition goals.",
      image: p3,
      tags: ["HTML", "CSS", "JS"],
      demoLink: "#",
      repoLink: "#",
